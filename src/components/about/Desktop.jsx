...
export default function Desktop() {
  ...
  const fileContent = files[activeFilePath.folder].filter(
    (a) => activeFilePath.file === a.name
  )[0];
  ...
  return (
    <motion.section
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="flex h-full overflow-hidden text-[14px] lg:flex-col"
    >
      ...
      <div className="border-r-2 border-custom w-[15rem] lg:hidden">
        <h2 className="flex items-center px-2 border-b-2 border-custom text-[#FFFFFF] py-1">
          <i className="ri-arrow-down-s-fill text-xl"></i>professional-info
        </h2>
        <div className="w-full border-b-2 border-custom py-2">
          <Folder
            folderName={"Professional Info"}
            color={"text-[#FEA55F]"}
        ...
        <a
          ...
          className="flex items-center px-2 gap-1  hover:text-[#FFFFFF] mt-3 mb-1"
        >
        ...
        <div className="flex-1 w-1/2 h-full flex flex-col lg:w-full">
          <div className="border-b-2 border-custom lg:border-none">
            <h2 className="flex items-center justify-between w-[15rem] opacity-0 px-2  border-r-2 border-custom py-1 lg:hidden">
              hello <i className="ri-close-line text-xl text-[#FFFFFF]"></i>
            </h2>
          </div>
          <div className="py-4 px-5 overflow-auto custom-scroll">
            <p className="mb-7 lg:text-[#FFFFFF] lg:text-[16px]">
