...
export default function Portfolio(props) {
    ...
    return (
        <motion.section
            ...
            className="mt-30 lg:mt-48 mb-44 md:mt-20 md:mb-28 font-inter">
            <div className="flex items-center">
                <motion.h1 className="text-3xl font-semibold text-amber-300  inline-block">Projects</motion.h1>
            ...
            <motion.div className='flex flex-row-reverse justify-between mt-32 lg:flex-col items-center'
                ...
                <div className='w-1/2 h-full relative pr-10 flex flex-col justify-between lg:pr-0 lg:w-full items-center'>
                    <h1 className=" text-center text-xs tracking-wide font-mono text-red-500 lg:mt-10 ">featured project</h1>
                    <h1 className=' text-2xl font-semibold text-slate-200  flex items-center justify-center'>Fitnessx</h1>
                    <p className='text-slate-400 mt-6 leading-7 text-l text-center  lg:w-10/12 md:w-full'>
                        This is a sleek, front-end gym website, featuring six distinct pages. It includes a mock shop page, a detailed classes page, and an informative about page. Despite its lack of back-end functionality, the site stands out with its smooth animations and stylish design, all crafted using Tailwind CSS and motion framer. It’s a visually appealing mock-up that prioritizes user experience and design.
                    </p>
                    <div className="flex justify-center mt-5 pb-3 flex-wrap">
                        <p className="font-mono py-1 px-3 text-slate-200 text-xs">Redux</p>
                        <p className="font-mono py-1 px-3 text-slate-200 text-xs">React router</p>
            ...
            <motion.div className='flex justify-between mt-32 lg:flex-col items-center'
                initial={{ y: 50, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                viewport={{ once: true }}
                transition={{ duration: .7 }}>
                <motion.div className=' bg-gray-200 w-1/2 h-96 overflow-hidden pfbox-3 lg:w-9/12 md:w-full sm:h-72 drop-shadow-lg shadow-amber-400'>

                </motion.div>
                <div className='w-1/2 h-full relative pl-10 flex flex-col justify-between lg:pl-0 lg:w-full items-center'>
                    <h1 className=" text-center text-xs tracking-wide font-mono text-red-500 lg:mt-10 ">featured project</h1>
                    <h1 className=' text-2xl font-semibold text-slate-200  flex items-center justify-center'>Coinsight</h1>
                    <p className='text-slate-400 mt-6 leading-7 text-l text-center  lg:w-10/12 md:w-full'>
                        This is an interactive cryptocurrency website powered by the CoinGecko API. It showcases trending and top 100 coins, offers a mock buying feature, and displays detailed price graphs. The site also highlights the latest free airdrop coins and trending news, making it a comprehensive hub for crypto enthusiasts.
                    </p>
                    <div className="flex justify-center mt-5 pb-3 flex-wrap">
                        <p className="font-mono py-1 px-3 text-slate-200 text-xs">Redux</p>
                        <p className="font-mono py-1 px-3 text-slate-200 text-xs">React router</p>
                        <p className="font-mono py-1 px-3 text-slate-200 text-xs">Tailwind CSS</p>
                        <p className="font-mono py-1 px-3 text-slate-200 text-xs">Framer-motion</p>
                        <p className="font-mono py-1 px-3 text-slate-200 text-xs">Charts JS</p>
                        <p className="font-mono py-1 px-3 text-slate-200 text-xs">Material UI</p>
                    </div>
                    <div className="flex justify-center mt-auto ">
                        <motion.a
                            initial={false}
                            ...
                            className="text-slate-200 font-mono flex px-5 py-2 mr-2 items-center pointer border-red-500 border" href="https://github.com/Baaz-Cheema/Coin-sight" target="_blank"><i className='bx bxl-github text-2xl pr-1' ></i>Code</motion.a>
                        <motion.a
                            initial={false}
                            whileHover={{
                                y: -2,
                            ...
                            className="text-slate-200 font-mono flex px-5 py-2 ml-2 items-center pointer  border-red-500 border" href="https://coinsightt.netlify.app/" target="_blank"><i className='bx bx-link-external text-2xl pr-1' ></i>Demo</motion.a>
                    </div>
                    <div>
                    </div>
                </div>
